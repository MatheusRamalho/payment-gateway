...
export function CardFlagAmex() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width={40}>
            <path
                id="logo-blue-box-small-45-9x45-a"
                fill="#ffffff"
                d="M44.9 44.9H0V0h44.9z"
            />
            <path
                fill="#006fcf"
                d="M44.9 24.2V-.1H0v44.9h44.9V31.7c-.1 0 0-7.5 0-7.5"
